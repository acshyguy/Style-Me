...
const Navbar = () => {
	return (
		<div className="bg-[#D1D7F0] w-full py-4  h-[90px] flex items-center justify-around">
			...
			<div className="hidden lg:flex gap-4">
				<button className="text-[#FCA311] bg-white px-6 py-2 border border-[#14213D] rounded-md">
					Login
				</button>
